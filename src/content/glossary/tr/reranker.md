...
hassas bir değerlendirmeyle yeniden sıralayan bileşendir. [Embedding](/dokumanlar/sozluk/embedding)
...
[RAG](/dokumanlar/sozluk/rag) hattındaki sırası: arama (embedding) → yeniden sıralama (reranker)
