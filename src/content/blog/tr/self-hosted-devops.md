...
Tabloyu tek cümleye indirmek mümkün. Bulutta üretim hattınızın koşulları başkasının elindedir, self-hosted'da hattın tamamı sizin denetiminizde döner. Aynı kıyasın yapay zeka tarafını [on-premise AI vs bulut](/blog/on-premise-ai-vs-bulut) yazısında açtık.
...
Self-hosted üretim hattı tek başına yarım resimdir. Hattı kuran altyapı, kodun güvenli aktığı boruları döşer; geliştiricinin editöründe kod tamamlayan ve açıklayan tarafı ise [kapalı ağda çalışan kod asistanı](/blog/kapali-agda-kod-asistani-copilot-alternatifi) tamamlar. Bu, platformun M2 Güvenli Kod Asistanı modülüdür: kod editöründe, kapalı ağda öneri üretir, kod binadan çıkmaz.
