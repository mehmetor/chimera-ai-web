...
> Bu sayfa bilgilendirme amaçlıdır; bağlayıcı bir teklif değildir. Modül eşleşmeleri için [Platform modüllerine](/platform/moduller) bakın.
...
Her ihtiyacın yazılım yığını, veri hazırlığı ve dürüst sınırları için ilgili [Platform modülüne](/platform/moduller) bakın. Kuruluma özel donanım ve model kararı [Mimari Ön-Analiz](/nasil-baslariz)'de netleşir.
